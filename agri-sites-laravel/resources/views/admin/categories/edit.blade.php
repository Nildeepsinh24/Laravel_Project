    ...
    <div class="container-fluid p-0">
        <div class="premium-header">
            <div class="text-center">
                ...
                <p class="header-subtitle">Update category information</p>
            </div>
        </div>
    </div>
</section>
                ...
                <div class="premium-form-card">
                    <form action="{{ route('admin.categories.update', $category) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" value="{{ old('name', $category->name) }}" class="form-control @error('name') is-invalid @enderror" required placeholder="Enter category name">
                            @error('name')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="slug" value="{{ old('slug', $category->slug) }}" class="form-control @error('slug') is-invalid @enderror" placeholder="Leave empty for auto-generation">
                            @error('slug')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
