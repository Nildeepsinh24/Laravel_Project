...
<body>
    ...
    <!-- ============ ERROR hiro section start ========== -->

    <div class="container-fluid er-main-c-f p-0">

        <div class="row main-row-error">

            <div class="col-md-6 er-bg-right" data-aos="fade-up" data-aos-duration="1000">
            ...
            <div class="col-md-6 er-cnct-left">
                ...
                <div class="cnct-er-mndv">
                    <img src="404.png" class="img-fluid fofw" data-aos="fade-up" data-aos-duration="1000">
                    ...
                    <button type="button" class="btn btn-md shop-btn-error btnefct-2" data-hover="Click me!"
                        data-aos="fade-up" data-aos-duration="900"><a href="index.html">Go to Homepage &nbsp;<i
                                class="bi bi-arrow-right-circle-fill"></i></a></button>
        ...
        <div class="row footer-main-row-mn">
            ...
            <div class="col-md-3 footer-three-clm">
                ...
                <ul class="ftr-mn-ul">
                    ...
                    <li class="ftr-mn-li-right-side">
                        <p class="ftr-msct-right-side"><a href="error.html" class="active">404 Not Found</a></p>
                    </li>
