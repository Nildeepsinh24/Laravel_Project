                    ...
                    <div class="col-md-6 s8-cl-hf-one" data-aos="fade-up" data-aos-duration="1000">
                        ...
                        <div class="s8-bg-first">
                            ...
                            <div class="s8-pcnct">
                                ...
                                <p class="s8-pm-pera"><span class="people-s8icn"><i
                                            class="bi bi-person-fill"></i></span>
                                    &nbsp; By Rachi Card</p>

                                <div class="sec-8-cnct-one-pss8">
                                    <h5 class="cnct-one-h">The Benefits of Vitamin D & How to Get It</h5>
                                    <p class="cnct-one-pss8">Simply dummy text of the printing and typesetting industry.
                                        Lorem Ipsum</p>
                                </div>

                                <button type="button" class="btn btn-md shop-btn-s5 rcnt-btn-smpl"><a
                                        href="Blog-Single.html">Read More &nbsp;<i
