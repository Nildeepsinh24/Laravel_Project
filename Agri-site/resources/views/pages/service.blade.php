...
<head>
    ...
    <!-- ====== favicon ===== -->
    <link rel="shortcut icon" href="link-logo-removebg-preview.jpg" type="image/x-icon">
    <!-- ===== og image =====  -->
    <meta property="og:image" content="https://fmtmagazine.in/wp-content/uploads/2021/02/Organic-Food.jpg" />
    <!-- ===== bootstrap link =====  -->
...
<body>
    ...
    <nav class="navbar navbar-expand-md sticky-top navbar-light mnnvbr">
        ...
        <div class="container-fluid">
            <a class="navbar-brand" href="#"><img src="Logo.svg" class="img-fluid logoimg"></a>
            ...
            <div class="collapse navbar-collapse header-dpdn" id="navbarSupportedContent">
                ...
                <div class="df-media">
                    <div class="input-group flex-nowrap header-inpt-cntrl">
                        ...
                        <span class="input-group-text search-bar-head" id="addon-wrapping"><i
        ...
        <div class="row service-page-main-hiro-row">
            ...
            <div class="col-md-4 cl-hiro-srvc-one">
                ...
                <ul class="right-side-service-ul" data-aos="fade-up" data-aos-duration="1000">
                    <li><img src="service-right-side-icon-oneIcon.svg" class="img-fluid"></li>
                    <li class="srvc-h-li">Dairy Products</li>
                    <li>
                        <p class="service-one-one-1-pera">Sed ut perspiciatis unde omnis iste natus error sit voluptat
                            accusantium doloremqlaudantium. Sed ut perspiciatis</p>
                    </li>
                </ul>

                <ul class="right-side-service-ul" data-aos="fade-up" data-aos-duration="1000">
                    <li><img src="service-right-two-side-icon-oneIcon.svg.png" class="img-fluid"></li>
                ...
                <ul class="right-side-service-ul" data-aos="fade-up" data-aos-duration="1000">
                    <li><img src="service-right-three-side-icon-oneIcon.svg.pngIcon.svg" class="img-fluid"></li>
            ...
            <div class="col-md-4 cl-hiro-srvc-two p-0">
                ...
                <img src="center-service-product-photos-removebg-preview.png" class="img-fluid" data-aos="flip-left"
            ...
            <div class="col-md-4 cl-hiro-srvc-three">
                ...
                <ul class="left-side-service-ul" data-aos="fade-up" data-aos-duration="1000">
                    <li><img src="service-left-three-side-icon-oneIcon.svg.pngIcon.svg.png" class="img-fluid"></li>
                    <li class="srvc-h-li">Agricultural Services</li>
                    <li>
                        <p class="service-one-two-1-pera">Sed ut perspiciatis unde omnis iste natus error sit voluptat
                            accusantium doloremqlaudantium. Sed ut perspiciatis</p>
                    </li>
                </ul>

                <ul class="left-side-service-ul" data-aos="fade-up" data-aos-duration="1000">
                    <li><img src="service-left-one-side-icon-oneIcon.svg.pngIcon.svg.png.png" class="img-fluid"></li>
                ...
                <ul class="left-side-service-ul" data-aos="fade-up" data-aos-duration="1000">
                    <li><img src="service-right-two-side-icon-oneIcon.svg.pngIcon.svg.svg" class="img-fluid"></li>
            ...
            <p class="text-center servisecespbtns5-s8no">
                <button type="button" class="btn btn-md shops8-btns8-s8-none btnefct-1"><a
                        href="service-single.html">Explore More
        ...
        <div class="container-fluid p-0">
            ...
            <div class="row clean-service-page-main-row">
                <div class="clean-video-main">
                    ...
                    <h2 class="oupd-abt-h-one-team" data-aos="fade-up" data-aos-duration="1000">Everyday Fresh & Clean
                    </h2>
                    <p class="clean-video-pera-tm mt-3">Simply dummy text of the printing and typesetting industry.
                        Lorem had ceased to been the industry's standard dummy text ever since the
                    </p>

                    <div class="video-icom-clean btnefct-1" data-aos="flip-left" data-aos-easing="ease-out-cubic"
                        data-aos-duration="2000"><a href="#"><i class="bi bi-play-fill"></i></a></div>
        ...
        <div class="row footer-main-row-mn">
            ...
            <div class="col-md-6 footer-two-clm">
                ...
                <div class="footer-center-main">
                    ...
                    <img src="Logo.svg" class="img-fluid" data-aos="fade-up" data-aos-duration="1000">

                    <p class="f-c-m-pera-fcm">Simply dummy text of the printing and typesetting industry. Lorem Ipsum
                    ...
                    <div class="social-main-cnct">
                        ...
                        <div class="main-icn-social">
                            <a href="#">
                                <img src="Fb.png" class="img-fluid">
                            </a>
                        </div>

                        <div class="main-icn-social">
                            <a href="#">
                                <img src="Twiter.png" class="img-fluid">
                            </a>
                        </div>

                        <div class="main-icn-social">
                            <a href="#">
                                <img src="Pintrest.png" class="img-fluid">
                            </a>
                        </div>
            ...
            <div class="col-md-3 footer-three-clm">
                ...
                <ul class="ftr-mn-ul">
                    ...
                    <li class="ftr-mn-li-right-side">
                        <p class="ftr-msct-right-side"><a href="Style-Guid.html">Style Guide</a>
                        </p>
                    </li>

                    <li class="ftr-mn-li-right-side">
                        <p class="ftr-msct-right-side"><a href="error.html">404 Not Found</a></p>
                    </li>


                    <li class="ftr-mn-li-right-side">
                        <p class="ftr-msct-right-side"><a href="Password-Protect.html">Password Protected</a></p>
                    </li>

                    <li class="ftr-mn-li-right-side">
                        <p class="ftr-msct-right-side"><a href="Licenses.html">Licences</a>
                        </p>
                    </li>

                    <li class="ftr-mn-li-right-side">
                        <p class="ftr-msct-right-side"><a href="Changelog.html">Changelog</a></p>
                    </li>
    ...
    <!-- ===== content footer main End =====  -->

    <!-- ===== section End coppy right start ===== -->
