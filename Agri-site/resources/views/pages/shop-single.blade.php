...
<body>
            ...
            <div class="row ss-main-row">
                ...
                <div class="col-md-6 clm-one-ss-one">
                    ...
                    <div class="card-body buy-img-ss">
                        ...
                        <div class="s-img-cntr">
                            <img src="shop-single-600-removebg-preview.png" class="img-fluid" data-aos="flip-left"
                ...
                <div class="col-md-6 clm-one-ss-two">
                    ...
                    <div class="ss-buy-content-one">
                        ...
                        <h4 class="cnct-one-1head-oactmd" data-aos="fade-up" data-aos-duration="1000">Health Pistachios
                        </h4>
                        ...
                        <p class="cnct-one-1-pera mt-2">Simply dummy text of the printing and typesetting industry.
                            Lorem had
                        ...
                        <div class="main-b">
                            ...
                            <div class="m-smain">
                                <div class="input-group gp-iand-b">
                                    ...
                                    <button type="button" class="btn btn-md shop-single-btn btnefct-2"
                                        data-hover="Click me!"><a href="#">Add To Cart
    ...
    <!-- =========== shop-single product-d and additional-info section start ============  -->
    ...
    <section id="pd-and-ainf">
        ...
        <div class="container pd-and-ainfo-main">
            ...
            <div class="a-and-p-dv">
                <button type="button" class="btn btn-md shop-single-btn s-9btn"><a href="#">Product
                        Description</a></button>
                <button type="button" class="btn btn-md add-infobtn"><a href="#">Additional Info</a></button>
            </div>

            <p class="p-d-and-add-info-one-1-pera mt-3">Welcome to the world of natural and organic. Here you can
                discover the
                bounty of nature. We have grown on the principles of health, ecology, and care. We aim to give our
                customers a healthy chemical-free meal for perfect nutrition. It offers about 8-10% carbs. Simple sugars
                — such as glucose and fructose — make up 70% and 80% of the carbs in raw.</p>

        </div>

    </section>

    <!-- =========== shop-single product-d and additional-info section End ============  -->

    <!-- ========== shop-single related more products Start ==========  -->
                        ...
                        <a href="#">
                            <div class="card section-3-card-main">
                                <div class="card-body">
                                    ...
                                    <img src="card-7.png" class="img-fluid c-i-7" alt="...">
                        ...
                        <a href="#">
                            <div class="card section-3-card-main">
                                <div class="card-body">
                                    ...
                                    <img src="card-6.png" class="img-fluid" alt="...">
                    ...
                    <div class="col-md-3 card-cl-three card-cl-mt" data-aos="fade-up" data-aos-duration="1000">
                        <a href="#">
                            <div class="card section-3-card-main">
                                <div class="card-body">
                                    <span class="card-title ctone">Millets</span>
                                    <img src="card-5.png" class="img-fluid c-5-r" alt="...">
                    ...
                    <div class="col-md-3 card-cl-four card-cl-mt" data-aos="fade-up" data-aos-duration="1000">
                        <a href="#">
                            <div class="card section-3-card-main">
                                <div class="card-body">
                                    <span class="card-title ctone">Vegetable</span>
                                    <img src="card-4.png" class="img-fluid ottre" alt="...">
    ...
    <!-- =========== shop -single related more product End ========== -->
